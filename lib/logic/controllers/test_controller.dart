...
////////////////////////////////////////////////////////////////////////////////
  ...
  Future<void> checkRepeated() async {
    ...
    *  uniqueBssids: [22:53:49:1e:b1:46, 30:74:96:08:35:64, ec:3e:b3:23:d7:02, 90:9a:4a:fd:75:1e, 30:c5:0f:f9:37:40, 84:d8:1b:2d:0b:80]}*/
    ...
    List uniqueBssids =decodedSigData['uniqueBssids'];
...
// print('fdddddddddddddddddddddd        ${uniqueBssids}');
    ...
    //   double mCorrel = Correl(decoded, statsList) + fact;
    //   print('correlation value    $mCorrel');
    //
    //   showToast(text: mCorrel.toString(), state: ToastStates.SUCCESS);
    //   // print(div());
    //   mCorrel >= 0.7 ? isInside.value = true : isInside.value = false;
    // }else{
    //   showToast(text: '000000', state: ToastStates.SUCCESS);
    //   isInside.value = false;
    // }
...
// Function to calculate kurtosis.
  double kurtosis(List<double> arr) {
    ...
    fact2 = ((3 * pow((arr.length - 1), 2)) / ((arr.length - 2) * (arr.length - 3)));

    for (var element in arr) {
      sum += pow((element - arr.average), 4);
    }
    sum2 = sum / pow((std), 4);
